...
CREATE TABLE `tabla` (
  ...
  `videoimagen` varchar(200) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Puede ser video o imagen',           
  `marquee` char(1) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'N' COMMENT 'N:No. V:Vertical, H:Horizontal',  
  PRIMARY KEY (`id`)
...
El resultado lo puedes ver [aquí](http://gildusnetworks.com/demo3)
